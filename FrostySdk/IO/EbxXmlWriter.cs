    ...
    if (FieldType.Name == "List`1") {
      ...
      if (FieldType.Namespace == "FrostySdk.Ebx" && FieldType.BaseType != typeof(Enum)) {
        if (FieldType == typeof(CString))
          ...
          SB.Append(Value.ToString());
        else if (FieldType == typeof(FileRef))
          SB.Append(Value.ToString());
        else if (FieldType == typeof(TypeRef))
          SB.Append(Value.ToString());
        else if (FieldType == typeof(BoxedValueRef))
          SB.Append(Value.ToString());
        ...
        if (FieldType == typeof(byte))
          SB.Append(((byte)Value).ToString("X2"));
          ...
          SB.Append(((ulong)Value).ToString("X16"));
