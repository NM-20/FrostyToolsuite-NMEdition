...
public struct Sha1 {
  ...
  public byte[] ToByteArray() {
    ...
    bytes[(0 * 4) + 0] = (byte)(a & 0xFF);
    bytes[(0 * 4) + 1] = (byte)((a >> 8) & 0xFF);
    bytes[(0 * 4) + 2] = (byte)((a >> 16) & 0xFF);
    bytes[(0 * 4) + 3] = (byte)((a >> 24) & 0xFF);
    bytes[(1 * 4) + 0] = (byte)(b & 0xFF);
    bytes[(1 * 4) + 1] = (byte)((b >> 8) & 0xFF);
    bytes[(1 * 4) + 2] = (byte)((b >> 16) & 0xFF);
    bytes[(1 * 4) + 3] = (byte)((b >> 24) & 0xFF);
    bytes[(2 * 4) + 0] = (byte)(c & 0xFF);
    bytes[(2 * 4) + 1] = (byte)((c >> 8) & 0xFF);
    bytes[(2 * 4) + 2] = (byte)((c >> 16) & 0xFF);
    bytes[(2 * 4) + 3] = (byte)((c >> 24) & 0xFF);
    bytes[(3 * 4) + 0] = (byte)(d & 0xFF);
    bytes[(3 * 4) + 1] = (byte)((d >> 8) & 0xFF);
    bytes[(3 * 4) + 2] = (byte)((d >> 16) & 0xFF);
    bytes[(3 * 4) + 3] = (byte)((d >> 24) & 0xFF);
    bytes[(4 * 4) + 0] = (byte)(e & 0xFF);
    bytes[(4 * 4) + 1] = (byte)((e >> 8) & 0xFF);
    bytes[(4 * 4) + 2] = (byte)((e >> 16) & 0xFF);
    bytes[(4 * 4) + 3] = (byte)((e >> 24) & 0xFF);
    return bytes;
  }
