...
public static class TextureUtils {
  ...
  public static Vortice.DXGI.Format ToTextureFormat(string pixelFormat, bool bLegacySrgb = false) {
    ...
    case "NormalDXT1":
      return Vortice.DXGI.Format.BC1_Typeless;
    case "NormalDXN":
      return Vortice.DXGI.Format.BC5_Typeless;
    ...
    case "BC1_UNORM":
      return Vortice.DXGI.Format.BC1_Typeless;
    case "BC2_SRGB":
      return Vortice.DXGI.Format.BC2_Typeless;
    case "BC2_UNORM":
      return Vortice.DXGI.Format.BC2_Typeless;
    //case "DXT3": return Vortice.DXGI.Format.BC2_UNorm;
    case "BC3_SRGB":
      return Vortice.DXGI.Format.BC3_Typeless;
    case "BC3_UNORM":
      return Vortice.DXGI.Format.BC3_Typeless;
    case "BC3A_UNORM":
      return Vortice.DXGI.Format.BC3_Typeless;
    case "BC3A_SRGB":
      return Vortice.DXGI.Format.BC3_Typeless;
    case "BC4_UNORM":
      return Vortice.DXGI.Format.BC4_Typeless;
    ...
    case "BC7":
      return Vortice.DXGI.Format.BC7_Typeless;
    case "BC7_SRGB":
      return Vortice.DXGI.Format.BC7_Typeless;
    case "BC7_UNORM":
      return Vortice.DXGI.Format.BC7_Typeless;
