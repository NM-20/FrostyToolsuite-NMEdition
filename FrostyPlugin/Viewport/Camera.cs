    ...
    public abstract class BaseCamera {
      ...
      protected D3DUtil_CameraKeys MapKey(System.Windows.Input.Key inKey) {
        ...
        case System.Windows.Input.Key.LeftCtrl:
          return D3DUtil_CameraKeys.CAM_CONTROLDOWN;
        case System.Windows.Input.Key.RightCtrl:
          return D3DUtil_CameraKeys.CAM_CONTROLDOWN;
        case System.Windows.Input.Key.Left:
          return D3DUtil_CameraKeys.CAM_STRAFE_LEFT;
        case System.Windows.Input.Key.Right:
          return D3DUtil_CameraKeys.CAM_STRAFE_RIGHT;
        case System.Windows.Input.Key.Up:
          return D3DUtil_CameraKeys.CAM_MOVE_FORWARD;
        case System.Windows.Input.Key.Down:
          return D3DUtil_CameraKeys.CAM_MOVE_BACKWARD;
        case System.Windows.Input.Key.Prior:
          return D3DUtil_CameraKeys.CAM_MOVE_UP;
        case System.Windows.Input.Key.Next:
          return D3DUtil_CameraKeys.CAM_MOVE_DOWN;
        ...
        case System.Windows.Input.Key.LeftShift:
          return D3DUtil_CameraKeys.CAM_SPEED;
        case System.Windows.Input.Key.Home:
          return D3DUtil_CameraKeys.CAM_RESET;
        }
      ...
      protected virtual Point UpdateMouseDelta() {
        ...
        if (curMouseDelta.X > 10)
          curMouseDelta.X = 10;
        else if (curMouseDelta.X < -10)
          curMouseDelta.X = -10;
        if (curMouseDelta.Y > 10)
          curMouseDelta.Y = 10;
        else if (curMouseDelta.Y < -10)
          curMouseDelta.Y = -10;
