...
class StaticBlockEntry : BaseDepotEntry {
  ...
  public override void Read(NativeReader reader, AssetManager am) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      switch (value) {
      case 1:
        bde = new PersistentBlockEntry();
        break;
      case 2:
        bde = new StaticBlockEntry();
        break;
      case 3:
        bde = new MeshBlockEntry();
        break;
      default:
...
class ParameterEntry {
  ...
  public string Write(ref int tabCount) {
    ...
    case 0x0cc971f4: /* Int64 */
      sb.Append(BitConverter.ToUInt64(Value, 0).ToString());
      break;
    case 0xb0bc3c22: /* Uint32 */
      sb.Append(BitConverter.ToUInt32(Value, 0).ToString());
      break;
    case 0x0d1cfa1b: /* Uint8 */
