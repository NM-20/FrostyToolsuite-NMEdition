  ...
  public unsafe MeshRenderLod(RenderCreateState state, MeshSetLod lod, MeshMaterialCollection materials, MeshRenderSkeleton skeleton) {
    ...
    foreach (MeshSetSection section in lod.Sections) {
      ...
      if (lod.IsSectionRenderable(section) || lod.IsSectionInCategory(section, MeshSubsetCategory.MeshSubsetCategory_ZOnly)) {
        ...
        case PrimitiveType.PrimitiveType_LineList:
          renderSection.PrimitiveType = PrimitiveTopology.LineList;
          break;
        case PrimitiveType.PrimitiveType_LineStrip:
          renderSection.PrimitiveType = PrimitiveTopology.LineStrip;
          break;
        case PrimitiveType.PrimitiveType_PointList:
          renderSection.PrimitiveType = PrimitiveTopology.PointList;
          break;
        case PrimitiveType.PrimitiveType_TriangleList:
          renderSection.PrimitiveType = PrimitiveTopology.TriangleList;
          break;
        case PrimitiveType.PrimitiveType_TriangleStrip:
          renderSection.PrimitiveType = PrimitiveTopology.TriangleStrip;
          break;
        }
