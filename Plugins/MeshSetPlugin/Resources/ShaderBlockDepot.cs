...
namespace MeshSetPlugin.Resources {
  ...
  public class ParameterEntry {
    ...
    public object GetValue() {
      ...
      switch (TypeHash) {
      case 0x9638b221:
        retVal = BitConverter.ToBoolean(Value, 0);
        break;
      case 0x0d1cfa1b:
        retVal = Value[0];
        break;
      case 0xb0bc3c22:
        retVal = BitConverter.ToUInt32(Value, 0);
        break;
      case 0x7f39a7b4:
        retVal = BitConverter.ToSingle(Value, 0);
        break;
      case 0xcc971f4:
        retVal = BitConverter.ToInt64(Value, 0);
        break;
      case 0xad0abfd3:
      ...
      break;
      case 0x3AD97822:
        retVal = (RvmLevelOfDetail)BitConverter.ToInt32(Value, 0);
        break;
      case 0x963FC9FC:
        retVal = (PrimitiveType)BitConverter.ToInt32(Value, 0);
        break;
      case 0x85EA841F:
        retVal = (ShaderInstancingMethod)BitConverter.ToInt32(Value, 0);
        break;
      }
      return retVal;
    }
    ...
    public void SetValue(object value) {
      switch (TypeHash) {
      case 0x9638b221:
        Value = new byte[1] { (byte)(((bool)value) ? 1 : 0) };
        break;
      case 0x0d1cfa1b:
  ...
  public class ShaderBlockDepot : Resource {
    ...
    public override void Read(NativeReader reader, AssetManager am, ResAssetEntry entry, ModifiedResource modifiedData) {
      ...
      for (int i = 0; i < count; i++) {
        ...
        switch (type) {
        case 0:
          bde = new ShaderBlockEntry();
          sbEntries.Add(bde as ShaderBlockEntry);
          break;
        case 1:
          bde = new ShaderPersistentParamDbBlock();
          break;
        case 2:
          bde = new ShaderStaticParamDbBlock();
          break;
        case 3:
          bde = new MeshParamDbBlock();
          break;
        case 4:
          bde = new ShaderBlockMeshVariationEntry();
          break;
        }
