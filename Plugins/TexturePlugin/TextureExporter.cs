...
public class FrostyTextureCubeItem : FrostyTextureSettingsItem {
  ...
  public override string ToString() {
    string faceString = "";
    switch (Face) {
    case FrostyTextureCubeFace.PositiveX:
      faceString = "X+";
      break;
    case FrostyTextureCubeFace.NegativeX:
      faceString = "X-";
      break;
    case FrostyTextureCubeFace.PositiveY:
      faceString = "Y+";
      break;
    case FrostyTextureCubeFace.NegativeY:
      faceString = "Y-";
      break;
    case FrostyTextureCubeFace.PositiveZ:
      faceString = "Z+";
      break;
    case FrostyTextureCubeFace.NegativeZ:
      faceString = "Z-";
      break;
    }
...
public class TextureExporter {
  ...
  private byte[] WriteToDDS(Texture textureAsset) {
    ...
    case "BC1A_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm_SRgb;
      break;
    case "BC1A_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm;
      break;
    case "BC1_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm_SRgb;
    ...
    case "BC2_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC2_UNorm_SRgb;
      break;
    case "BC3_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm_SRgb;
      break;
    case "BC3A_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm_SRgb;
    ...
    case "BC3_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm;
      break;
    case "BC3A_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm;
    ...
    case "BC4_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC4_UNorm;
      break;
    //case "DXT5": header.ddspf.dwFourCC = 0x35545844; break;
    //case "DXT5A": header.ddspf.dwFourCC = 0x31495441; break;
    case "BC5_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC5_UNorm;
      break;
    case "BC6U_FLOAT":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC6H_Uf16;
      break;
    case "BC7":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC7_UNorm;
      break;
    case "BC7_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC7_UNorm_SRgb;
      break;
    case "BC7_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.BC7_UNorm;
    ...
    case "R8_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R8_UNorm;
      break;
    case "R16G16B16A16_FLOAT":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R16G16B16A16_Float;
      break;
    case "ARGB32F":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R32G32B32A32_Float;
      break;
    ...
    case "R9G9B9E5F":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R9G9B9E5_SharedExp;
      break;
    case "R9G9B9E5_FLOAT":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R9G9B9E5_SharedExp;
    ...
    case "R8G8B8A8_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R8G8B8A8_UNorm;
      break;
    case "R8G8B8A8_SRGB":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R8G8B8A8_UNorm_SRgb;
      break;
    case "R10G10B10A2_UNORM":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R10G10B10A2_UNorm;
      break;
    case "L8":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R8_UNorm;
    ...
    case "L16":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R16_UNorm;
      break;
    case "ARGB8888":
      header.HasExtendedHeader = true;
      header.ExtendedHeader.dxgiFormat = Format.R8G8B8A8_UNorm;
      break;
    default:
      header.ddspf.dwFourCC = 0x00000000;
      break;
    }
