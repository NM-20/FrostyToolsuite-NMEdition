    ...
    public class TextureExporter
    {
        ...
        private byte[] WriteToDDS(Texture textureAsset)
        {
            ...
            switch (pixelFormat)
            {
                ...
                case "BC1A_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm; break;
                case "BC1_SRGB": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm_SRgb; break;
                case "BC1_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC1_UNorm; break;
                ...
                case "BC3_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm; break;
                case "BC3A_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC3_UNorm; break;
                case "BC4_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC4_UNorm; break;
                //case "DXT5": header.ddspf.dwFourCC = 0x35545844; break;
                //case "DXT5A": header.ddspf.dwFourCC = 0x31495441; break;
                case "BC5_UNORM": header.HasExtendedHeader = true; header.ExtendedHeader.dxgiFormat = Format.BC5_UNorm; break;
